...
function Sidebar({ isOpen, onClose, user }) {
  ...
  return (
    <div className={`sidebar fixed z-[3] top-0 right-0 lg:w-1/4 md:w-1/2 w-full h-full bg-[#18181B] rounded-tl-[30px] rounded-bl-[30px] border-l-[7px] border-[#C6C1C142] p-[34px] pt-[86px] transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
