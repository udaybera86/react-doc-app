...
function Card({ data, reference }) {
  ...
  return (
    <motion.div
      ...
      className="relative w-60 bg-zinc-900/90 min-h-72 rounded-[45px] px-8 py-9 text-[#F5F5F5] overflow-hidden cursor-grab"
    >
      ...
      <div className="footer absolute bottom-0 left-0 w-full">
        ...
        <a
          href={`assets/files/${data.tag.fileName}`}
          download={data.tag.fileName}
          style={data.style}
          className="tag flex items-center justify-center py-4 cursor-pointer"
        >
